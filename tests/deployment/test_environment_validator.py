...
def test_valid_environment_is_accepted():
    ...
    assert validator.validate(environment) is True
...
def test_missing_broker_is_rejected():
    ...
    assert validator.validate(environment) is False
...
def test_live_without_credentials_is_unsafe():
    ...
    assert validator.is_production_safe(environment) is False
...
def test_live_with_credentials_and_approval_is_safe():
    ...
    assert validator.is_production_safe(environment) is True
