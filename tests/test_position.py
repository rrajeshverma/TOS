...
position = Position(
    position_id="P202607140001",
    order=order,
    quantity=400,
    average_price=Decimal("248.35"),
    last_traded_price=Decimal("251.80"),
)

print(position)
print(position.is_open)
print(position.is_closed)
print(position.unrealized_points)
