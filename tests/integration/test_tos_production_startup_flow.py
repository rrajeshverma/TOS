...
class ProductionRuntime:
    ...
    def authenticate(self):
        if not self.config_loaded:
            raise RuntimeError("Configuration required")
    ...
    def start(self):
        if not self.market_connected:
            raise RuntimeError("Market connection required")
...
def test_configuration_loads_before_start():
    ...
    assert runtime.config_loaded is True
...
def test_production_runtime_starts():
    ...
    assert runtime.market_connected is True
...
def test_production_runtime_shutdown():
    ...
    assert runtime.market_connected is False
